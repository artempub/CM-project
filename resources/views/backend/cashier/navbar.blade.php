...
<nav class="navbar navbar-expand-lg">
    ...
    <a href="{{ url('/') }}" class="navbar-brand" style="padding:0" data-toggle="push-menu" role="button">
        <div id="apptitle">Crediting Tool</div>
    </a>
...
<b>
            ...
            <li class="nav-item">
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="/cashier/en.png" style="width:22px; height: auto;">
                    </a>
            ...
            <li class="nav-item">
                <a class="nav-link btn-blue" style="font-size:20px;" href="javascript:void(0)"><i class="fa fa-question"></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-blue" style="font-size:20px;" href="{{ route('backend.start_shift.print') }}"><i class="fa fa-print"></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-blue" style="font-size:20px;" href="javascript:void(0)" onclick="openRightSide()"><i class="fa fa-gear"></i></a>
            </li>
            <!-- <li class="nav-item">
...
<!-- 
            ...
            <li class="nav-item">
                <div class="dropdown">
                    <div style="background-color: #fff; border-radius: 5px; width: 80px; padding: 0 2px;">
                        <a href="{{ route('backend.auth.logout') }}" class="nav-link dropdown-toggle" style="padding-inline: unset !important; height: 32px; justify-content: space-between; ">
                        <div style="background-color: #acacac; border-radius: 50%; width: 25px; height:auto; display: flex; justify-content: center; align-items: center;">    
                            <span class="fa fa-power-off" style="height: 24px;    width: 24px;   color: rgb(246, 246, 246);    background: rgba(172 172 172);
                                display: flex;  align-items: center;  justify-content: center;   border-radius: 50%;  padding: 2px; font-size: 14px;">
                            </span>
                        </div>  
                        <span style="font-size: 12px; font-weight: 700; color: black;">   Logout</span>
                        </a>
                    </div>
