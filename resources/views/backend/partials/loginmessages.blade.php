        ...
        if( count($allInfos) ){
            foreach($allInfos AS $infoItem){
                if($infoItem->user){
                    ...
                    if($infoItem->user->hasRole('owner')){
...
@if (session('blockError'))
    ...
    <div  class="popup-modal show">
        <div  class="popup-modal-content">
    
          <div  class="popup-close-container">
            <img  class="popup-close" src="/frontend/Flaming777v1/img/_src/modal_close_btn.png">
          </div>
    
            <p  class="content">Errors in block {{ strtoupper(session('blockError')) }}</p>
...
@if(isset ($messages) && count($messages) > 0)
    ...
    <div  class="popup-modal show">
        <div  class="popup-modal-content">
          ...
          {{-- <h4>@lang('app.error')</h4> --}}
            <p  class="content">{!!  $messages[array_rand($messages)];  !!}</p>
...
@if(isset ($errors) && count($errors) > 0)
    ...
    <div  class="popup-modal show">
        <div  class="popup-modal-content">
          ...
          <h1 class="popup-title">@lang('app.notice')</h1>
          {{-- @foreach($errors->all() as $error) --}}
            <p  class="content">@lang('app.error_content')</p>
            {{-- @endforeach --}}
            </div>
          </div>
@endif
...
@if(settings('siteisclosed'))
    ...
    <div  class="popup-modal show">
        <div  class="popup-modal-content">
          ...
          <h4>@lang('app.turned_off')</h4>
            <p  class="content">@lang('app.site_is_turned_off')</p>
