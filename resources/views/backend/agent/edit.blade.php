...
@section('page-title', trans('app.edit_agent'))
@section('page-heading', $agent->present()->username)
...
@section('content')
    ...
    <section class="content">
        {!! Form::open(['route' => ['backend.agent.update.details', $agent->id], 'method' => 'PUT', 'id' => 'details-form']) !!}

        <div class="row">
            @include('backend.agent.partials.info')
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="@if(!Request::get('date') && !Request::get('page')) active @endif tab-pane" id="details">
                            @include('backend.agent.partials.edit')
                        </div>
        ...
        @if(!$agent->hasRole('admin'))
            @include('backend.agent.partials.modals', ['agent' => $agent])
        @endif
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('VanguardLTE\Http\Requests\Agent\UpdateDetailsRequest', '#details-form') !!}
    {!! JsValidator::formRequest('VanguardLTE\Http\Requests\Agent\UpdateLoginDetailsRequest', '#login-details-form') !!}
@stop
