<div class="modal fade" id="openAddModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('backend.agent.balance.update') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="AddId" name="agent_id" value="@if(isset($agent)){{ $agent->id }}@endif">
...
<div class="modal fade" id="openOutModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('backend.agent.balance.update') }}" method="POST" id="outForm">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="OutId" name="agent_id" value="@if(isset($agent)){{ $agent->id }}@endif">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    </div>
