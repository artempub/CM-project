...
@section('content')
    ...
    <section class="content">
        ...
        @if( Auth::user()->hasRole('agent') )
            ...
            @if($happyhour && auth()->user()->hasRole('agent'))
            ...
            {!! Form::open(['route' => 'backend.user.cash.massadd', 'files' => true, 'id' => 'mass-user-form']) !!}
        ...
        {!! Form::open(['route' => 'backend.user.cash.store', 'files' => true, 'id' => 'user-form']) !!}
