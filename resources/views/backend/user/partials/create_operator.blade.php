<div class="form-group col-md-10">
    ...
    <div class="col-md-4">
        <div class="input-group">
            ...
            <input type="hidden" class="form-control" id="user_role" name="user_role" value="operator">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="input-group">
            ...
            <select class="form-control" name="parent_operator" id="parent_operator" data-live-search="true">
                ...
                <option value="{{$child_operator->id}}" {{$child_operator->id == $recent_operator_id ? 'selected':''}}>{{$child_operator->username}}</option>
                @endforeach
            </select>
        </div>
    </div>
