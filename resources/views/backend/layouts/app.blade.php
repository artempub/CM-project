...
<head>
    ...
    <link rel="stylesheet" href="/back/bower_components/datatables.net-bs/css/dataTables.checkboxes.css">
	...
	<link rel="stylesheet" href="/back/dist/css/simple-line-icons.css">
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <strong><a href="#">{{ settings('app_name') }}</a></strong>
        </div>
            <strong>GS SOLUTION&nbsp;</strong> <strong>Ver .:</strong> 2023_1
    </footer>
...
<script src="/back/bower_components/datatables.net-bs/js/dataTables.checkboxes.js"></script>
...
<script src="/back/dist/js/alertify.min.js"></script>
