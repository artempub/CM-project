...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    ...
    Route::get('profile/convert', ['as' => 'frontend.profile.convert', 'uses' => 'ProfileController@convert']);
    ...
    */
    //apollo
    Route::get('/apollo/init-games', [
        'as' => 'frontend.apollo.init-games',
        'uses' => 'ApolloController@initGames'
    ]);

    Route::post('/apollo/get-game', [
        'as' => 'frontend.apollo.get-game',
        'uses' => 'ApolloController@getGame'
    ]);
    //wallet api
    Route::post('/apollo/callback', [
        'as' => 'frontend.apollo.callback',
        'uses' => 'ApolloController@callback'
    ]);
    //end slotegrator
...
Route::prefix('cashier')->middleware(['checker'])->group(function () {
    Route::namespace('Backend')->group(function () {
        Route::get('login', [
            'as' => 'cashier.auth.login',
            'uses' => 'Auth\AuthController@getLoginCashier'
        ]);
        Route::post('login', [
            'as' => 'cashier.auth.login.post',
            'uses' => 'Auth\AuthController@postLoginCashier'
        ]);
    });
});
...
Route::prefix('backend')->middleware(['auth', 'checker'])->group(function () {
    Route::namespace('Backend')->group(function () {
        ...
        //Operator->Home page route, by 2worldsoft

        Route::get('/home', [
            'as' => 'backend.home',
            'uses' => 'DashboardController@index_new',
            //
        ]);
        Route::post('/home', [
            'as' => 'backend.homelist',
        ...
        // Route::get('user', [
        //     'as' => 'backend.user.list',
        //     'uses' => 'UsersController@index_new',
        //     'middleware' => 'permission:users.manage'
        // ]);
        // Route::post('user', [
        //     'as' => 'backend.user.listpost',
        ...
        Route::post('user/storeaction', [
            'as' => 'backend.user.storeaction',
            'uses' => 'UsersController@store_action',
            'middleware' => 'permission:users.manage'
        ]);

        Route::post('get-transaction', [
            'as' => 'backend.transaction.get',
            'uses' => 'UsersController@get_transaction',
            'middleware' => 'permission:users.manage'
        ]);
        ...
        //By 2worldsoft, to get user hierarchy
        Route::get('usertree', [
            'as' => 'backend.user.manageusertree',
            'uses' => 'UsersController@manage_usertree',
            'middleware' => 'permission:users.tree'
        ]);
        /*
        Route::get('statistics', [
        ...
        */
        ...
        //Create operator/shop/user route, by 2worldsoft
        //--For Task 1--
        Route::get('/create/operator', [
            'as' => 'backend.user.createoperator',
            'uses' => 'UsersController@create_operator',
        ]);
        Route::post('/create/operator', [
            'as' => 'backend.user.storeoperator',
            'uses' => 'UsersController@store_hierarchy',
            'middleware' => 'permission:users.add'
        ]);

        Route::get('/create/shop', [
            'as' => 'backend.user.createshop',
            'uses' => 'UsersController@create_shop',

        ]);
        Route::post('/create/shop', [
            'as' => 'backend.user.storeshop',
            'uses' => 'UsersController@store_hierarchy',
            'middleware' => 'permission:users.add'
        ]);

        Route::get('/create/user', [
            'as' => 'backend.user.createuser',
            'uses' => 'UsersController@create_user'
        ]);
        Route::post('/create/user', [
            'as' => 'backend.user.storeuser',
            'uses' => 'UsersController@store_hierarchy',
            'middleware' => 'permission:users.add'
        ]);
        //--For Task 2--
        Route::get('/cash', [
            'as' => 'backend.showcash',
            'uses' => 'CashController@index_cash'
        ]);
        Route::post('/cash', [
            'as' => 'backend.cashlist',
            'uses' => 'CashController@index_cash'
        ...
        Route::post('user/profile/show', [
            'as' => 'backend.user.edit_profile',
            'uses' => 'UsersController@show_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('user/profile/password', [
            'as' => 'backend.user.change_pw',
            'uses' => 'UsersController@change_password',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('user/profile/remove', [
            'as' => 'backend.user.remove',
            'uses' => 'UsersController@remove_user',
            'middleware' => 'permission:users.manage'
        ]);

        Route::get('shops', [
            'as' => 'backend.shop.list',
            'uses' => 'ShopsController@index_new',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shops', [
            'as' => 'backend.shop.listpost',
            'uses' => 'ShopsController@index_new',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/profile/{user_id}', [
            'as' => 'backend.shop.profile',
            'uses' => 'ShopsController@show_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/profile/jpglist', [
            'as' => 'backend.shop.jpglistpost',
            'uses' => 'ShopsController@show_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/profile/categories', [
            'as' => 'backend.shop.categorylistpost',
            'uses' => 'ShopsController@show_gamecategories',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/profile/providers', [
            'as' => 'backend.shop.providerlistpost',
            'uses' => 'ShopsController@show_gameproviders',
            'middleware' => 'permission:users.manage'
        ]);

        Route::post('shop/profile/edit', [
            'as' => 'backend.shop.edit_profile',
            'uses' => 'ShopsController@edit_profile',
            'middleware' => 'permission:users.manage'
        ]);
        ...
        //For Shop Role only
        Route::get('shop/home', [
            'as' => 'backend.shop.home',
            'uses' => 'ShopsController@home',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/home', [
            'as' => 'backend.shop.homepost',
            'uses' => 'ShopsController@home',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/cash', [
            'as' => 'backend.shop.showcash',
            'uses' => 'ShopsController@show_cash',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/cash', [
            'as' => 'backend.shop.showcashpost',
            'uses' => 'ShopsController@show_cash',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/transactions', [
            'as' => 'backend.shop.transactions',
            'uses' => 'ShopsController@transactions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/transactions', [
            'as' => 'backend.shop.transactionspost',
            'uses' => 'ShopsController@transactions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/operatortransactions', [
            'as' => 'backend.shop.operatortransactions',
            'uses' => 'ShopsController@operator_transactions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/operatortransactions', [
            'as' => 'backend.shop.operatortransactionspost',
            'uses' => 'ShopsController@operator_transactions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/reset', [
            'as' => 'backend.shop.reset',
            'uses' => 'ShopsController@reset',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/reset', [
            'as' => 'backend.shop.resetpost',
            'uses' => 'ShopsController@reset',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/shifts', [
            'as' => 'backend.shop.shifts',
            'uses' => 'ShopsController@shifts',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/shifts', [
            'as' => 'backend.shop.shiftspost',
            'uses' => 'ShopsController@shifts',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/jackpot', [
            'as' => 'backend.shop.jackpot',
            'uses' => 'ShopsController@jackpot',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('shop/detail', [
            'as' => 'backend.shop.detail',
            'uses' => 'ShopsController@detail',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('shop/detail', [
            'as' => 'backend.shop.detailpost',
            'uses' => 'ShopsController@detail',
            'middleware' => 'permission:users.manage'
        ]);
        ...
        Route::get('operators', [
            'as' => 'backend.operator.list',
            'uses' => 'OperatorsController@index',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('operators', [
            'as' => 'backend.operator.listpost',
            'uses' => 'OperatorsController@index',
            'middleware' => 'permission:users.manage'
        ]);
        // Route::get('operator/profile/{user_id}', [
        //     'as' => 'backend.operator.profile',
        //     'uses' => 'OperatorsController@show_profile',
        //     'middleware' => 'permission:users.manage'
        // ]);

        Route::post('operator/profile/edit', [
            'as' => 'backend.operator.edit_profile',
            'uses' => 'OperatorsController@edit_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('operator/permissions/{user_id}', [
            'as' => 'backend.operator.permissions',
            'uses' => 'OperatorsController@show_permissions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('operator/permissions/edit', [
            'as' => 'backend.operator.edit_permission',
            'uses' => 'OperatorsController@show_permissions',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('operator/profile/show', [
            'as' => 'backend.operator.logged_operator_profile',
            'uses' => 'OperatorsController@logged_operator_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::post('operator/profile/show', [
            'as' => 'backend.operator.edit_operator_profile',
            'uses' => 'OperatorsController@edit_operator_profile',
            'middleware' => 'permission:users.manage'
        ]);
        Route::get('operator/faq/show', [
            'as' => 'backend.operator.logged_operator_faq',
            'uses' => 'OperatorsController@logged_operator_faq',
            'middleware' => 'permission:users.manage'
        ]);
