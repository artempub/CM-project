...
namespace VanguardLTE\Http\Controllers\Web\Backend {
    ...
    class GamesController extends \VanguardLTE\Http\Controllers\Controller
    {
        ...
        {
            $games = \VanguardLTE\Game::where('shop_id', 0)->select('gamelist.*')->get();
            // var_dump($games);die;
            if ($request->view != '') {
                $games = $games->where('view', $request->view);
            }
            ...
            // return $games->groupBy('game_provider')->get()->pluck('game_provider')->toJson();
            return \VanguardLTE\Category::pluck('href')->toJson();
        }
