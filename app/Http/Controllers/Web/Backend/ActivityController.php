...
namespace VanguardLTE\Http\Controllers\Web\Backend
{
    ...
    class ActivityController extends \VanguardLTE\Http\Controllers\Controller
    {
        ...
        public function index(\Illuminate\Http\Request $request, $type = '')
        {
            ...
            $activities = \VanguardLTE\Services\Logging\UserActivity\Activity::select('user_activity.*')->where('user_activity.country', '!=', 'Russia')->where('user_activity.country', '!=', 'Hong Kong')->orderBy('created_at', 'DESC');
